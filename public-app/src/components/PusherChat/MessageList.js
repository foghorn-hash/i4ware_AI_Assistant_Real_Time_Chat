...
let strings = new LocalizedStrings({
  en: {
    your_browser_does_not_support_video_tag: "Your browser does not support the video tag.",
    generateSpeech: "Generate Speech",
    stopSpeech: "Stop Speech"
  },
  fi: {
    your_browser_does_not_support_video_tag: "Selaimesi ei tue video tagia.",
    generateSpeech: "Luo puhe",
    stopSpeech: "Pysäytä puhe"
  },
  se: {
    your_browser_does_not_support_video_tag: "Din webbläsare stöder inte videomarkeringen.",
